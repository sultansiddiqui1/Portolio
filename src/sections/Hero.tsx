  ...
  return (
    ...
    >
      ...
      >
        ...
        ></div>
        {/* the rings, the syles defined in global.css */}
      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          <h1 className="font-serif text-3xl  md:text-5xl text-center mt-8 tracking-wide">
            Building exceptional User Experiences and bringing ideas to life
          </h1>
          <p className="mt-4 text-center text-white/60 md:text-lg">
            My name is Sadiq Siddiqui. I specialize in transforming designs into
            functional, high-performing web applications. Lets discuss our next
